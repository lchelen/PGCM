...
class GCN2S(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.stgcn2(out, self.supports)
        out = self.stgcn3(out, self.supports)
        out = self.stgcn4(out, self.supports)
        out = self.stgcn5(out, self.supports)
        #out = self.stgcn6(out, self.supports)
        #out = self.stgcn7(out, self.supports)
        out = self.stgcn8(out, self.supports)
